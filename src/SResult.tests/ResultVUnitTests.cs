...
public class ResultOfReasonUnitTests
{
    ...
    public void ResultOfReasonShouldFailTest()
    {
        ...
        {
            Assert.Equal("Something is wrong", (Failure)reason);
        }
    }
    ...
    // {
    //     return isPass ? "Rajesh completed assignment" : Failure.Error("Rajesh is a scoundrel");
    // }

    // public static Result2<int> PassResultThroughMethod(int marks)
    // {
    //     return marks > 50 ? marks : Failure.Error("Sumit is a hopeless");
    // }
}
